...
impl<'h> PyTrait<'h> for HeapObjectRead<'h, Template> {
...
impl<'h> HeapObjectRead<'h, Template> {
...
impl<'h> PyTrait<'h> for HeapObjectRead<'h, Interpolation> {
    fn py_type(&self, _vm: &VM<'h>) -> Type {
        Type::Interpolation
    }
